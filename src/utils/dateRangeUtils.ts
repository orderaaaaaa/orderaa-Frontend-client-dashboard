...
export function formatDateToLocalDate(date: Date | null): string | undefined {
  if (!date) return undefined;
...
export function formatLocalStartOfDay(date: Date): string {
  const year = date.getFullYear();
  const month = String(date.getMonth() + 1).padStart(2, '0');
  const day = String(date.getDate()).padStart(2, '0');
...
export function formatLocalEndOfDay(date: Date): string {
  const year = date.getFullYear();
  const month = String(date.getMonth() + 1).padStart(2, '0');
  const day = String(date.getDate()).padStart(2, '0');
