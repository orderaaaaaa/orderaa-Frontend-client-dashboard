...
const ReceiptsActionsBar = memo(
  ({ selectedCount, isVisible }: ReceiptsActionsBarProps) => {
...
ReceiptsActionsBar.displayName = 'ReceiptsActionsBar';

export default ReceiptsActionsBar;
