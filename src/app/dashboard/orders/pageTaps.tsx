...
function PageTaps({ data }: any) {
  return (
    <div className="flex gap-4 md:flex-wrap overflow-x-auto hide">
      ...
      <PageTab
        ...
        icon={
          <svg
            ...
            width={22}
            height={22}
            className="fill-[#5D24E1] transition group-hover:fill-white"
            viewBox="0 0 640 640"
          >
      ...
      />
      <PageTab label="تم الغاء" icon={<CircleX width={18} height={18} />} />
      <PageTab
        label="تم التحضير"
        count={2}
      ...
      />
      <PageTab label="تقارير" icon={<FileText width={18} height={18} />} />
      <PageTab label="مرتجع مسلم" icon={<Copy width={18} height={18} />} />
      <PageTab
        label="تم التحصيل"
        icon={<ClipboardCheck width={18} height={18} />}
      />
      <PageTab label="تسليم جزئي" icon={<FileScan width={18} height={18} />} />
      <PageTab label="طلبات مفقوده" icon={<FileX width={18} height={18} />} />
    </div>
  );
}
