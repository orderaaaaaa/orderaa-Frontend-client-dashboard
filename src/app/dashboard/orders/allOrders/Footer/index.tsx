...
const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center sm:items-center justify-center sm:justify-between gap-4 px-6 pb-6 bg-gray-50 rounded-lg relative bottom-0">
      {/* Total Items */}
      <button className="flex gap-1 text-sm bg-[#5D24E1] rounded-full text-white py-2 px-3  justify-center items-center cursor-pointer">
      ...
      <div className="flex flex-col sm:flex-row gap-2 items-center justify-center sm:justify-start">
        ...
        <Button
          variant="outline"
          className="flex items-center rounded-3xl !px-5 !py-2 border-[#5D24E1] text-[#5D24E1] hover:bg-purple-50 cursor-pointer"
        >
          <Truck />
          <span>شحن</span>
        </Button>
