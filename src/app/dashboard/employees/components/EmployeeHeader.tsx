  ...
  return (
    <div className="sm:px-8 py-2 flex flex-row-reverse justify-between items-start">
      <Link href="/dashboard/employees/add-employee">
        <button className="bg-[#5D24E1] cursor-pointer text-white px-2 sm:px-10 py-2 rounded-full font-semibold text-xs flex items-center gap-1 sm:gap-2 hover:bg-[#5a3ec7] transition-colors">
