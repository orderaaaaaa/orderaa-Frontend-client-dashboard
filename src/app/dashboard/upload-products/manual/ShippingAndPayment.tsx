  ...
  return (
    <div className="bg-gray-50 px-6 flex items-center justify-center" dir="rtl">
      <div className="w-full bg-white border border-gray-200 rounded-xl max-sm:p-2 p-8 shadow-sm">
        <h1 className="font-bold text-[28px] mb-6">الشحن والدفع</h1>
        ...
        <div className="space-y-8">
          ...
          <div className="border-b border-gray-100 pb-0">
            <div className="flex items-center justify-between mb-3">
              <div className="flex-1">
                <h2 className="text-[18px] text-[#1F1F1F] mb-5">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              <div className="flex-1">
                <h2 className="text-[19px] text-[#1F1F1F] mb-5">
                  يحتاج إلى تأكيد
                </h2>
