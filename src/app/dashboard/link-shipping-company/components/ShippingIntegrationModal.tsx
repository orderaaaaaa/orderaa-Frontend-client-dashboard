...
export const ShippingIntegrationModal: React.FC<Props> = ({
  ...
  const isRedOrHashtag = providerLower === 'red' || providerLower === 'hashtag' || providerLower === 'jt_express' || providerLower === 'quick_connect' || providerLower === 'rm_express' || providerLower === 'torod';
