  ...
  return (
    <section className="relative py-20 text-white overflow-hidden">
      <div className="container mx-auto flex flex-col md:flex-row px-6 gap-10 relative">
        ...
        <div className="w-full md:w-1/2 text-right relative">
          <ul className="space-y-5 text-[19px]">
            <li className="flex items-center gap-3">
              ...
              <Check className="text-[#8E6BFF] w-5 h-5" />
            </li>
            <li className="flex items-center gap-3">
        ...
        <div className="relative bottom-5 right-40 flex flex-col w-full max-w-[80%] text-center gap-4 justify-center md:justify-center">
          <h3 className="text-2xl">إدارة الفريق بذكاء</h3>
          <Image
        ...
        {/* ✅ Bottom Card - Full Width Across Both Columns */}
        <div className="absolute bottom-20 left-[960px] transform p-16 -translate-x-1/2 w-full max-w-[1050px] backdrop-blur-lg bg-white/5 border-2 border-[#5D24E1]/40 rounded-[30px] flex flex-col md:flex-row justify-between items-stretch gap-6">
          {data.map((item, i) => (
            <div
              key={i}
