  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          "border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 hover:bg-primary/5",
        secondary:
      ...
      size: {
        default: "h-8 px-3 py-1.5 has-[>svg]:px-2.5 sm:h-9 sm:px-4 sm:py-2 sm:has-[>svg]:px-3",
        xs: "h-6 rounded-md gap-1 px-1.5 text-xs has-[>svg]:px-1 sm:h-7 sm:px-2 sm:has-[>svg]:px-1.5",
        sm: "h-7 rounded-md gap-1.5 px-2.5 has-[>svg]:px-2 sm:h-8 sm:px-3 sm:has-[>svg]:px-2.5",
        lg: "h-9 rounded-md px-4 has-[>svg]:px-3 sm:h-10 sm:px-6 sm:has-[>svg]:px-4",
        xl: "h-10 rounded-lg px-6 text-sm has-[>svg]:px-4 sm:h-12 sm:px-8 sm:text-base sm:has-[>svg]:px-5",
        icon: "size-8 sm:size-9",
        "icon-xs": "size-6 sm:size-7",
