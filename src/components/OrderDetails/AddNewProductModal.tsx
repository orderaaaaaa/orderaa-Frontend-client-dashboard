    ...
    >
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          className="fixed top-[50%] left-[50%] z-50 -translate-x-1/2 -translate-y-1/2 w-full max-w-[827px] mx-4 md:mx-0 min-h-[450px] max-h-[85vh] bg-white rounded-[20px] shadow-xl flex flex-col overflow-hidden"
