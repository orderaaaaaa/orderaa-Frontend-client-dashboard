    ...
    >
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          className={`fixed top-[50%] left-[50%] z-50 -translate-x-1/2 -translate-y-1/2 w-full max-w-[500px] bg-white rounded-[20px] shadow-xl transition-all duration-300 ${showSuccess ? 'scale-95 opacity-90' : 'scale-100 opacity-100'}`}
