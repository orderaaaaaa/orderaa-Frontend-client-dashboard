...
import { LiaLockSolid, LiaCommentDotsSolid } from 'react-icons/lia';
    ...
    >
      <div className="space-y-4">
        <div className="flex items-center gap-2 text-[#5F5E5E]">
          <LiaLockSolid className="w-5 h-5" />
          <p className="text-sm">هل أنت متأكد من تحديد الطلب كـ في انتظار الدفع؟</p>
        </div>
