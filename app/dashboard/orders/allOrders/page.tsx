              ...
              >
                  ...
                  >
                    <span className="inline-flex items-center gap-2">
                      ...
                      <span className="inline-flex items-center gap-1">
                        ...
                        <span
                         className="inline-flex items-center justify-center min-w-5 h-5 px-1 rounded-full bg-[#5D24E1]
                         group-hover:bg-[#ffffff] group-hover:text-[#5D24E1] text-white text-[11px]">
                          {data.length}
                        </span>
                      </span>
                    </span>
                    ...
                    >
                      <div className="flex flex-col gap-1">
                        ...
                        <input
                          ...
                          className="w-44 px-3 py-2 rounded border border-gray-300 bg-white"
                        />
                      </div>
                      <div className="flex flex-col gap-1">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <input
                          ...
                          className="w-52 px-3 py-2 rounded border border-gray-300 bg-white"
                        />
                      </div>
                      <div className="flex flex-col gap-1">
                        <label className="text-xs text-gray-600">
                ...
                >
                  {paginatedData.map((row, i) => (
                    ...
                    >
                      <Card
                        className="h-full flex justify-between bg-gradient-to-tr from-purple-300
                       to-purple-150
                        backdrop-blur-md border
                       border-white/50 shadow-lg"
                      >
                        <CardContent className="text-sm ">
                          <div className="flex justify-between" dir="">
