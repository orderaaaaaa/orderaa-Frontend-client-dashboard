          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex items-center text-xs text-green-600">
                  <TrendingUp className="mr-1 h-3 w-3" />+{revenueGrowth}% from last month
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex items-center text-xs text-green-600">
                  <TrendingUp className="mr-1 h-3 w-3" />+{ordersGrowth}% from last month
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">${(currentMonth.revenue / currentMonth.orders).toFixed(2)}</div>
                    ...
                    <div key={data.month} className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <Progress value={(data.revenue / 30000) * 100} className="h-2" />
                        </div>
                      </div>
