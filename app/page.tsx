...
<div className="p-8 md:p-12 flex items-center">
  ...
  <form dir="rtl" onSubmit={handleLogin} className="w-full max-w-md space-y-5 mx-auto">
    <div className="space-y-3">
      <Image className="mx-auto" src="/ordera.svg" alt="Ordera" width={250} height={109} priority />
      <h1 className="text-2xl font-bold text-center">أهلاً بك من جديد!</h1>
      <p className="text-sm text-gray-500 text-center">سجّل دخولك للمتابعة مع Orderaa</p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div>
        <label className="block text-sm text-gray-700 mb-1">البريد الالكتروني / رقم الموبايل</label>
    ...
    <p className="text-center text-sm text-gray-500">
      ليس لديك حساب؟ <a href="/signUp" className="text-[#5D24E1] hover:underline">أنشئ حسابًا</a>
    </p>
  </form>
</div>
  </div>
