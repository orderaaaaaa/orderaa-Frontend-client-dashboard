          ...
          {!customMode && (
            <>
              ...
              <ul className="max-h-60 overflow-auto py-1">
                {filtered.length === 0 && (
                  <li className="px-3 py-2 text-sm text-gray-500 text-right">
                    لا توجد نتائج
                  </li>
                )}
      ...
      <div className="w-full max-w-5xl bg-white border rounded-2xl shadow-xl grid grid-cols-1 md:grid-cols-2 overflow-hidden">
        ...
        <div className="p-8 md:p-12 flex items-center">
          <form
            ...
            className="w-full max-w-lg space-y-5 mx-auto"
          >
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-500 text-center">
                سجّل بيانات متجرك والبدء مع Orderaa
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    من 10 إلى 15 رقمًا بدون مسافات.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      {showConfirmPassword ? (
                        <EyeOff className="h-4 و-4 text-gray-500" />
                      ) : (
                        <Eye className="h-4 و-4 text-gray-500" />
                      )}
                    </button>
                    <Lock className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400 pointer-events-none" />
                    <input
